...
public class BasicController {
    ...
    @Resource
    private FormatAddressAssistant formatAddressAssistant;
    @Resource
...
//        return openAiChatModel.chat(String.format("请根据以下牌局的日志进行尽量详细总结，样式美观：%s", String.join("\n", exLogs)));
    ...
    // 测试：帮我发一条微企业微信消息给张仁杰，内容是建议他中午在上海复地活力城商场买点什么好吃的回家
...
//        System.out.println(addressDto);
        ...
        Result<String> result = chatAssistant.chat(1111, userMessageName, userMessage);
