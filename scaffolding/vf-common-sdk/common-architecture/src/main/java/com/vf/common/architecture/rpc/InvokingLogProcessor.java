package com.vf.common.architecture.rpc;

import com.vf.common.architecture.log.AccessLogContext;
import com.vf.common.architecture.log.AccessLogStrategy;
import com.vf.common.architecture.log.AccessLogStrategySelector;
import com.vf.common.base.BusinessException;
...
public class InvokingLogProcessor {
    ...
    @Pointcut("@annotation(com.vf.common.base.annotation.AccessLog)")
    public void process() {
    }
